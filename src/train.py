...
from simcse.models import RobertaForCL, BertForCL, MT5ForCL
...
def main():
    ...
    wandb.init(project="mt5test-savemodel")
    ...
    # datasets["train"] = datasets["train"].select(range(300))
    # Prepare features
    ...
    class OurDataCollatorWithPadding:
        ...
        def __call__(self, features: List[Dict[str, Union[List[int], List[List[int]], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
            special_keys = ['input_ids', 'attention_mask', 'mlm_input_ids', 'mlm_labels']
            bs = len(features)
            if bs > 0:
    ...
    # Kiểm tra trạng thái các tham số trước khi huấn luyện
    print("Trạng thái các tham số trước khi huấn luyện:")
